...
public class EventDemo {
   ...
   public static void main(String[] args) {
      ...
      for (z = 0; z < events.length; ++z) {
         ...
         // Calling constructor for the Event
         events[z] = new Event(eventNum, numOfGuests);
         // Setting event type for each array
         events[z].setEventType(getType());
      }
      // Cycling through the array with a FOR loop to display the each event
      for (z = 0; z < events.length; ++z) {
   ...
   public static int getType() {
      ...
      // Outputting a list of offered event types
